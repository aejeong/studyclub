                                 ...
                                 <!-- ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ -->
										<div class="btn-group-lg pt-3 pr-3 text-left">
											<c:choose>
													...
													<button type="button" class="btn btn-success" onclick="location.href='http://localhost:3500/members'">관리자 페이지</button>
												 </c:when>
                  ...
                  <c:forEach var="Reserve_past" items="${Reserve_past}">
                     <c:if test="${not empty Reserve_past}">
                        <div style="float: left;">
                           ...
                           <img src="https://chart.googleapis.com/chart?cht=qr&chs=200x200&chl=http%3a%2f%2f172.16.31.159%3a9999%2fojo%2fmypage%2fqrcode%3f${Reserve_past.rcode }%26${Reserve_past.ucode}">
