										...
										<div class="comment-details">
											<div class="row justify-content-between">
												...
												<div class="col-lg-3 col-md-6 col-sm-7 rating text-right">
												  ...
												  <span><i class="fa fa-thumbs-up fa-2x" aria-hidden="true" style="color: green" id="rec_update" onclick="rec_update(${roomContent.rvcode});">
										 &nbsp;<c:if test="${roomContent.rvcode == 0}"></c:if><span
